...
class RpcMessage private constructor() {
    companion object {
        ...
        const val SerialTrackerCustomCommandRequest: UByte = 71u
        const val VRCConfigSettingToggleMute: UByte = 72u
        const val TrackingChecklistRequest: UByte = 73u
        const val TrackingChecklistResponse: UByte = 74u
        const val IgnoreTrackingChecklistStepRequest: UByte = 75u
        const val StartUserHeightCalibration: UByte = 76u
        const val CancelUserHeightCalibration: UByte = 77u
        const val UserHeightRecordingStatusResponse: UByte = 78u
        const val KeybindRequest: UByte = 79u
        const val ChangeKeybindRequest: UByte = 80u
        const val KeybindResponse: UByte = 81u
        const val InstalledInfoRequest: UByte = 82u
        const val InstalledInfoResponse: UByte = 83u
